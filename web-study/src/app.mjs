...
document.addEventListener('submit',async e=>{
 ...
 try{
 if(form.id==='settings-form'){const v=Object.fromEntries(new FormData(form));await append('settings',{typing:v.typing==='on',fontSize:+v.fontSize});dialog.close();void sync();}
